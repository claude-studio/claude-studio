...
const TOOLTIPS = {
  cacheHitRate: '전체 캐시 요청 중 캐시가 재사용된 비율입니다. 높을수록 API 비용이 절감됩니다.',
  estimatedSavings: '캐시 읽기 토큰은 일반 입력 토큰보다 저렴하여 발생한 예상 절약 비용입니다.',
  cacheCreation: '처음 캐시를 생성할 때 사용된 토큰 수입니다. 캐시 저장 비용이 발생합니다.',

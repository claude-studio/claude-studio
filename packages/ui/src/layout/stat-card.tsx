...
export function StatCard({ title, value, description, trend, className, featured }: StatCardProps) {
  return (
    ...
    >
      ...
      <div className="px-5 pt-5 pb-5 pl-6 min-w-0">
        <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-[0.2em] mb-3 truncate">
          {title}
        </p>

        <div
          className={cn(
            'font-bold tracking-tight font-mono leading-none whitespace-nowrap overflow-hidden',
